...
const ProtectedRoute = ({ children, allowedRoles }) => {
  ...
  if (allowedRoles?.length && !allowedRoles.includes(user.role_name)) {
    return <Navigate to={getDefaultRouteByRole(user.role_name)} replace />;
  }
...
const App = () => {
  return (
    <Routes>
      ...
      >
        <Route index element={<Navigate to="/administrator/overview" replace />} />
        <Route path="overview" element={<AdministratorOverview />} />
        <Route path="projects" element={<AdministratorProjects />} />
        <Route path="tasks" element={<AdministratorTasks />} />
        ...
        <Route path="attendance" element={<AdministratorAttendance />} />
      </Route>
