...
const employeeVisitSummary = useMemo(() => {
  ...
  teamVisits.forEach((visit) => {
    ...
    people.push({
      name: visit.employee_name || visit.full_name || "-",
      id: visit.employee_id,
    });


    if (visit.team_members) {
...
.map((employee)=>{
      const checked = selectedVisitors.includes(
...
>
  Selected: {selectedVisitors.length} employee(s)
</p>
            </label>
